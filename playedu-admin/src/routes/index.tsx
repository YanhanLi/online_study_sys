...
const GradeOverviewPage = lazy(() => import("../pages/grade/overview"));
const GradeAnalysisPage = lazy(() => import("../pages/grade/analysis"));
const GradeStudentPage = lazy(() => import("../pages/grade/student"));
//学员相关
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: "/quiz",
            element: <PrivateRoute Component={<QuizPage />} />,
          },
          {
            path: "/grade/overview",
            element: <PrivateRoute Component={<GradeOverviewPage />} />,
          },
          {
            path: "/grade/analysis/:quizId",
            element: <PrivateRoute Component={<GradeAnalysisPage />} />,
          },
          {
            path: "/grade/student",
            element: <PrivateRoute Component={<GradeStudentPage />} />,
          },
          {
