            ...
            new ArrayList<>() {
                {
                                    ...
                                    put(
                                            ...
                                            """
                                                    CREATE TABLE `course_hour` (
                                                      ...
                                                      `rid` int(11) NOT NULL DEFAULT 0 COMMENT '资源ID',
                                                      `quiz_id` int(11) NOT NULL DEFAULT 0 COMMENT '练习ID',
                                        ...
                                        add(
                                                        new HashMap<>() {
                                                                {
                                                                        put("table", "course_hour_add_quiz_id");
                                                                        put("name", "20241005_10_00_00_course_hour_add_quiz_id");
                                    put(
                                            "sql",
                                            """
                                                    ALTER TABLE `course_hour`
                                                    ADD COLUMN `quiz_id` int(11) NOT NULL DEFAULT 0 COMMENT '练习ID' AFTER `rid`;
                                                    """);
                                }
                            });
                    ...
                    add(
                            new HashMap<>() {
                                {
                                    put("table", "questions");
                                    put("name", "20241005_10_05_00_questions");
                                    put(
                                            "sql",
                                            """
                                                    CREATE TABLE `questions` (
                                                      `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
                                                      `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '题目类型',
                    ...
                    add(
                            new HashMap<>() {
                                {
                                    put("table", "quizzes");
                                    put("name", "20241005_10_10_00_quizzes");
                                    put(
                                            "sql",
                                            """
                                                    CREATE TABLE `quizzes` (
                                                      ...
                                                      `question_ids` json NOT NULL COMMENT '题目ID集合',
                                                      `admin_id` int(11) NOT NULL DEFAULT 0 COMMENT '管理员ID',
                                                      `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                                      `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
                                                      PRIMARY KEY (`id`)
                    ...
                    add(
                            new HashMap<>() {
                                {
                                    put("table", "quizzes_add_category_exam_date");
                                    put("name", "20251124_10_00_00_quizzes_add_category_exam_date");
                                    put(
                                            "sql",
                                            """
                                                    ALTER TABLE `quizzes`
                                                    ADD COLUMN `category` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ONLINE_AUTO' COMMENT '考试分类[ONLINE_AUTO:线上自动,OFFLINE_MANUAL:线下人工]' AFTER `title`,
                                                    ADD COLUMN `exam_date` datetime NULL DEFAULT NULL COMMENT '考试时间' AFTER `pass_score`;
                                                    """);
                                }
                            });
                    ...
                    add(
                            new HashMap<>() {
                                {
                                    put("table", "user_quiz_records");
                                    put("name", "20241005_10_15_00_user_quiz_records");
                                    put(
                                            "sql",
                                            """
                                                    CREATE TABLE `user_quiz_records` (
                                                      ...
                                                      `user_id` int(11) NOT NULL DEFAULT 0 COMMENT '学员ID',
                                                      `quiz_id` int(11) NOT NULL DEFAULT 0 COMMENT '练习ID',
                                                      `course_hour_id` int(11) NOT NULL DEFAULT 0 COMMENT '课时ID',
                                                      `score` int(11) NOT NULL DEFAULT 0 COMMENT '得分',
                                                      `is_passed` tinyint(4) NOT NULL DEFAULT 0 COMMENT '是否及格[1:是,0:否]',
                                                      `user_answers` json NOT NULL COMMENT '作答内容',
                                                      `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                                      PRIMARY KEY (`id`),
                                                      KEY `uqr_user_quiz` (`user_id`, `quiz_id`),
                                                      KEY `uqr_hour` (`course_hour_id`)
                                                    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT '练习作答记录表';
                                                    """);
                                }
                            });
                                        ...
                                        add(
                                                        new HashMap<>() {
                                                                {
                                                                        put("table", "user_quiz_records_add_comment");
                                                                        put("name", "20251124_10_05_00_user_quiz_records_add_comment");
                                                                        put(
                                                                                        "sql",
                                                                                        """
                                                                                                        ALTER TABLE `user_quiz_records`
                                                                                                        ADD COLUMN `comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '老师评语' AFTER `user_answers`;
                                                                                                        """);
                                                                }
                                                        });
                                        ...
                                        add(
                                                        new HashMap<>() {
                                                                {
                                                                        put("table", "grade_statistics");
                                                                        put("name", "20251124_10_10_00_grade_statistics");
                                                                        put(
                                                                                        "sql",
                                                                                        """
                                                                                                        CREATE TABLE `grade_statistics` (
                                                                                                          ...
                                                                                                          `avg_score` decimal(10,2) NOT NULL DEFAULT 0 COMMENT '平均分',
                                                                                                          `max_score` int(11) NOT NULL DEFAULT 0 COMMENT '最高分',
                                                                                                          `min_score` int(11) NOT NULL DEFAULT 0 COMMENT '最低分',
                                                                                                          `pass_rate` decimal(5,2) NOT NULL DEFAULT 0 COMMENT '及格率',
                                                                                                          `distribution` json NOT NULL COMMENT '分数段分布',
                                                                                                          `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                                                                                          PRIMARY KEY (`id`),
                                                                                                          UNIQUE KEY `quiz_id` (`quiz_id`)
                                                                                                        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT '成绩统计缓存表';
                                                                                                        """);
                                                                }
                                                        });
