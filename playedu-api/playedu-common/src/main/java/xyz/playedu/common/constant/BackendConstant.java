...
public class BackendConstant {
    ...
    public static final String COURSE_HOUR_TYPE_VIDEO = "VIDEO";
    public static final String COURSE_HOUR_TYPE_QUIZ = "QUIZ";

    public static final String[] COURSE_HOUR_TYPE_WHITELIST = {
        COURSE_HOUR_TYPE_VIDEO,
        COURSE_HOUR_TYPE_QUIZ
    };
    public static final String[] COURSE_HOUR_TYPE_WHITELIST_TEXT = {"视频", "练习"};

    public static final String QUIZ_CATEGORY_ONLINE_AUTO = "ONLINE_AUTO";
    public static final String QUIZ_CATEGORY_OFFLINE_MANUAL = "OFFLINE_MANUAL";

    public static final String[] QUIZ_CATEGORY_WHITELIST = {
        QUIZ_CATEGORY_ONLINE_AUTO,
        QUIZ_CATEGORY_OFFLINE_MANUAL
    };
    ...
    public static final String[] QUESTION_TYPE_WHITELIST = {
        QUESTION_TYPE_SINGLE,
        QUESTION_TYPE_MULTIPLE,
        QUESTION_TYPE_TRUE_FALSE
    };

    public static final String[] QUESTION_TYPE_WHITELIST_TEXT = {"单选题", "多选题", "判断题"};
