...
public class UserCourseHourRecordServiceImpl
    ...
    @Override
    public void markFinished(Integer userId, Integer courseId, Integer hourId) {
        UserCourseHourRecord record = find(userId, courseId, hourId);
        Date now = new Date();
        if (record == null) {
            UserCourseHourRecord insertRecord = new UserCourseHourRecord();
            ...
            insertRecord.setCourseId(courseId);
            insertRecord.setHourId(hourId);
            insertRecord.setTotalDuration(0);
            insertRecord.setFinishedDuration(0);
            insertRecord.setIsFinished(1);
            insertRecord.setFinishedAt(now);
        ...
        UserCourseHourRecord updateRecord = new UserCourseHourRecord();
        updateRecord.setId(record.getId());
        updateRecord.setIsFinished(1);
        updateRecord.setFinishedAt(now);
        updateRecord.setFinishedDuration(record.getTotalDuration());
